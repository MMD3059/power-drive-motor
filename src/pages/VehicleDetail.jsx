...
import { ArrowLeft, Fuel, Gauge, Car, Zap, Thermometer, ShieldCheck, Check, Phone, Mail, MapPin, ChevronLeft, ChevronRight, X } from "lucide-react"
...
export default function VehicleDetail() {
  ...
  const specs = [
    ...
    { label: "Seats", value: `${car.seats} Seats`, icon: Thermometer },
