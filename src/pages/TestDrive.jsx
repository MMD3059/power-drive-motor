        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="glass-card rounded-xl p-6 space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <input type="email" name="email" value={form.email} onChange={handleChange} required={form.contactMethod === "email"} placeholder={t("testDrive.email")} className="w-full px-4 py-3.5 bg-dark-700/80 border border-neon-500/10 rounded-xl text-white placeholder-dark-300 focus:outline-none focus:border-neon-500/40" />
                <input type="tel" name="phone" value={form.phone} onChange={handleChange} required={form.contactMethod === "call" || form.contactMethod === "sms"} placeholder={t("testDrive.phone")} className="w-full px-4 py-3.5 bg-dark-700/80 border border-neon-500/10 rounded-xl text-white placeholder-dark-300 focus:outline-none focus:border-neon-500/40" />
              </div>
